const SEARCH_LIST = [
{ "link": "/post/pytorch-caltech101/", "title" : "【pytorch】caltech-101 を使ってAIモデルの歴史を辿る【VGG16からEfficientNetまで】" }, 
...
{ "link": "/post/django-do-not-use-customtemplatetags/", "title" : "【Django】カスタムテンプレートタグを実装させずにページネーションと検索を両立させる【Paginator】" }, 
...
{ "link": "/post/django-auto-create-views/", "title" : "【Django】models.pyとforms.pyからviews.pyを自動的に作る【コマンド1発で生成】" }, 
{ "link": "/post/django-auto-create-urls/", "title" : "【Django】views.pyからurls.pyを自動的に作る【コマンド1発で生成】" }, 
...
{ "link": "/post/django-ajax/", "title" : "DjangoでAjax(jQuery)を実装、送信と同時に投稿内容を確認する" }, 
{ "link": "/post/django-ajax-thumbnail-upload/", "title" : "Djangoで動画投稿時にサムネイルもセットでアップロードする【DRF+Ajax(jQuery)+canvas】" }, 
{ "link": "/post/django-ajax-restful/", "title" : "DjangoでAjax(jQuery)を実装する方法【Django REST Framework使用】" }, 
...
{ "link": "/post/django-async-websocket-consumer-scope/", "title" : "Django-channelsのAsyncWebsocketConsumerのscopeの内容【JWT認証+Sec-Websocket-Protocol】" }, 
...
{ "link": "/post/react-setstate-trap/", "title" : "setStateする時、直接値を書き換えてはいけない" }, 
{ "link": "/post/react-route-dom-how-to-use/", "title" : "react-router-domの使い方【Reactでルーティング】" }, 
{ "link": "/post/npm-install-bootstrap/", "title" : "npm で Bootstrap を使う" }, 
{ "link": "/post/vite-create-react-project/", "title" : "create-react-app コマンドはもう使えないので、ViteでReactプロジェクトをつくる" }, 
{ "link": "/post/drf-400-error-serializer/", "title" : "DRFで400 Bad Request エラーが出る時、Serializerを確認する" }, 
...
{ "link": "/post/python-arrow-def/", "title" : "【Python】def関数のアロー(->)はアノテーション" }, 
...
{ "link": "/post/vim-snipmate-plugin/", "title" : "【Vimでスニペット】snipmateプラグイン" }, 
...
{ "link": "/post/startup-gatsby/", "title" : "Reactベースの静的サイトジェネレーターGatsbyを使う" }, 
...
{ "link": "/post/python-smb-access/", "title" : "PythonからWindows共有サーバー(Samba)にアクセスする" }, 
...
{ "link": "/post/django-deploy-heroku-github/", "title" : "【Django】GitHubを使ってHerokuにデプロイをする" }, 
...
{ "link": "/post/django-modelformset-factory/", "title" : "【Django】modelformset_factoryで1回のリクエストでまとめて投稿する【フォームセット】" }, 
...
{ "link": "/post/django-querydict-union/", "title" : "【Django】検索結果(QuerySet)を結合する【.union()】" }, 
{ "link": "/post/vim-auto-indent/", "title" : "Vimで自動的にインデントする。gg=Gでファイル内の全てをオートインデントする" }, 
...
{ "link": "/post/django-auto-create-all-apps-link/", "title" : "【Django】各アプリのトップページとアプリ名をまとめてレンダリングする【apps.pyとurls.pyを操作】" }, 
{ "link": "/post/django-views-import-usermodel/", "title" : "【Django】views.pyでユーザーモデルを扱う時は get_user_model を使う" }, 
...
{ "link": "/post/django-summernote-auto-thumbnail/", "title" : "Django Summernoteを使ったブログで、本文の画像を記事のサムネイルにするには【BeautifulSoup使用】" }, 
...
{ "link": "/post/django-deploy-render/", "title" : "poetryなしでDjangoをRender.comへデプロイする【Herokuの代替クラウド、アカウント作成から解説】" }, 

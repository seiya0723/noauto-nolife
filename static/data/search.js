const SEARCH_LIST = [
{ "link": "/post/django-control-cookie/", "title" : "【Django】Cookieをサーバーサイドで操作をする" }, 
...
{ "link": "/post/heroku-origin-domain/", "title" : "Herokuに独自ドメインを設定する【ムームードメイン】" }, 
{ "link": "/post/django-openpyxl/", "title" : "DjangoでOpenpyxlを動かし、一部のセルを編集した上でダウンロードさせる" }, 
{ "link": "/post/startup-django-stripe/", "title" : "【Stripe】Djangoにクレジットカード決済機能を実装させる" }, 
{ "link": "/post/startup-centos-7/", "title" : "CentOS 7 をインストールした直後にやる設定" }, 
...
{ "link": "/post/django-allauth-center-loginpage/", "title" : "Django-allauthにてログイン画面を中央寄せにさせる【テンプレートのカスタマイズ】" }, 
{ "link": "/post/chartjs-responsive-chart/", "title" : "chart.jsでグラフ表示幅と高さを指定する。" }, 
{ "link": "/post/django-essential-python/", "title" : "Djangoをやる前に知っておきたいPython構文【オブジェクト指向と別ファイル読み込みは特に重要】" }, 

...
上記の設定だと文字サイズが小さすぎるのでbarの太さを調整してみた。
...
<body>
    ...
    const gantt = new Gantt("#gantt", tasks, {
                    // ganttの設定 https://github.com/frappe/gantt
                    header_height: 50,
                    column_width: 30,
                    step: 24,
...
<div class="img-center"><img src="/images/Screenshot from 2023-05-30 11-38-49.png" alt=""></div>
